  ...
  return (
    ...
    <div className='relative flex items-center'>
      ...
      <input
        ...
        className={`w-full h-10 rounded-lg border-1 border-black h-13 p-7 pl-18 focus:outline-hidden focus:border-[#d7da2f] cursor-pointer ${props.amountErrorMessage ? 'border-red-500' : 'border-black'}`}
      />
